...
export default function MyDashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {ptUser && !ptUser.coupang_api_connected && !ptUser.is_test_account && !ptUser.coupang_vendor_id && (
        <ApiConnectionBanner
          variant="nudge"
      ...
      {ptUser && (ptUser.coupang_api_connected || !!ptUser.coupang_vendor_id) && <CoupangOverviewWidget />}
