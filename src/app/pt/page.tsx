...
const faqData = [
  ...
  { q: '계약 기간이 끝나면 어떻게 되나요?', a: '계약 만료 30일 전까지 해지를 통보하지 않으시면 동일 조건으로 1년씩 자동 연장됩니다. 해지를 원하시면 30일 전에 서면으로 통보해 주시면 됩니다. 다만, 계약 종료 시 자동화 프로그램을 통해 등록한 상품은 14일 이내에 철거해야 하며, 프로그램 접근 권한은 계약 기간 중에만 유효합니다.' },
