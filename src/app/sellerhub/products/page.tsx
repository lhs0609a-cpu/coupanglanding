...
import { CHANNELS, CHANNEL_SHORT_LABELS, CHANNEL_STATUS_LABELS } from '@/lib/sellerhub/constants';
...
import BulkRegisterPanel from '@/components/sellerhub/BulkRegisterPanel';
...
export default function ProductsPage() {
  ...
  const handleBulkRegister = async () => {
    ...
    for (const id of selectedIds) {
      await fetch(`/api/sellerhub/products/${id}/register`, {
        method: 'POST',
      ...
      <div className="flex items-center justify-between">
        ...
        {tab === 'list' && (
          <div className="flex items-center gap-2">
            <button
              onClick={() => fetch('/api/sellerhub/products/sync-coupang', { method: 'POST' }).then(() => fetchProducts())}
