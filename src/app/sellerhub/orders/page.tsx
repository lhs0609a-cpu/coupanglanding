...
import { CHANNELS, CHANNEL_SHORT_LABELS, CHANNEL_COLORS, ORDER_STATUS_LABELS, ORDER_STATUS_COLORS } from '@/lib/sellerhub/constants';
import type { Channel, Order, OrderStatus } from '@/lib/sellerhub/types';
...
export default function OrdersPage() {
  ...
  const handleBulkConfirm = async () => {
    ...
    await fetch('/api/sellerhub/orders/bulk/confirm', {
      method: 'POST',
