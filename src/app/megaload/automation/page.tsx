...
import type { AutomationRule, TriggerType, ActionType } from '@/lib/megaload/types';
...
export default function AutomationPage() {
  ...
  const fetchRules = async () => {
    setLoading(true);
    const res = await fetch('/api/megaload/automation/rules');
  ...
  const createRule = async () => {
    ...
    await fetch('/api/megaload/automation/rules', {
      method: 'POST',
