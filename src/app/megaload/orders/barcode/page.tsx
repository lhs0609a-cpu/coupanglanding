...
import { CHANNEL_SHORT_LABELS, CHANNEL_COLORS } from '@/lib/megaload/constants';
import type { Order } from '@/lib/megaload/types';
...
export default function BarcodeOrdersPage() {
  ...
  const handleScan = async (value: string) => {
    ...
    // 송장 등록 API 호출
    const res = await fetch(`/api/megaload/orders/${(order as Record<string, unknown>).id}/invoice`, {
      method: 'POST',
