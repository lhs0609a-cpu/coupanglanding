...
export const GUIDE_ARTICLES: GuideArticle[] = [
    ...
    steps: [
      ...
      },
      {
        ...
        detailedInstructions: [
          ...
          'IP주소 란에 아래 주소를 모두 입력하세요 (10개, 콤마로 구분):',
          ...
          'URL 란에 다음을 입력하세요: https://coupanglanding.vercel.app/',
          '"확인" 버튼을 눌러 저장합니다.',
        ],
    ...
    steps: [
      ...
      },
      {
        ...
        detailedInstructions: [
          ...
          '자동 관리: 셀러 통합 관리 툴 사용 (사방넷, 메가로드, 플레이오토 등).',
  ...
  // ── 1. 네이버 품절/단종 시 대처법 ──
  {
    articleId: 'naver-stockout-handling',
    categoryId: 'orders-shipping',
    title: '네이버 품절/단종 시 대처법',
    subtitle: '소싱 상품이 품절됐을 때 주문 취소부터 대체 상품 찾기까지',
    icon: '🚫',
    estimatedTime: '약 10분',
    overview:
      '네이버에서 소싱하던 상품이 갑자기 품절되거나 단종되면 쿠팡에서 주문이 들어와도 발송할 수 없어요. 품절을 빨리 발견하고, 주문이 있으면 즉시 취소 처리하고, 대체 상품을 찾는 전체 과정을 알려드립니다.',
    steps: [
      {
        title: '매일 소싱 상품 재고 확인하기',
        description: '쿠팡에 올려놓은 상품의 네이버 원본 페이지를 매일 확인하세요.',
        detailedInstructions: [
          '쿠팡에 등록한 상품의 네이버 원본 URL을 엑셀이나 메모장에 정리해두세요.',
          '매일 아침 (주문이 몰리기 전) 네이버 원본 페이지를 하나씩 열어 확인하세요.',
          '"품절", "일시품절", "판매종료" 표시가 있는지 확인하세요.',
          '옵션 상품이라면 특정 옵션만 품절인 경우도 있으니 모든 옵션을 확인하세요.',
          '확인이 끝나면 품절 상품은 즉시 쿠팡에서 판매중지 처리하세요.',
        ],
        tip: '등록 상품이 많으면 전부 확인이 힘들어요. 판매량 상위 20개 상품만이라도 매일 확인하세요. 나머지는 2~3일에 한 번 확인하면 됩니다.',
        warning: '품절 상품을 방치하면 쿠팡 주문 취소 → 페널티 → 셀러 등급 하락으로 이어져요. 가장 치명적인 실수 중 하나입니다!',
      },
      {
        title: '쿠팡에서 즉시 판매중지 처리',
        description: '품절 확인 즉시 쿠팡 Wing에서 해당 상품을 판매중지합니다.',
        detailedInstructions: [
          '쿠팡 Wing에 로그인하세요.',
          '"상품관리" → "상품 조회/수정"으로 이동하세요.',
          '품절된 상품을 검색하여 찾으세요.',
          '"판매중지" 버튼을 클릭하세요.',
          '사유를 "재고 소진"으로 선택하면 됩니다.',
        ],
        externalLink: { url: 'https://wing.coupang.com', label: '쿠팡 Wing 바로가기' },
        tip: '판매중지해도 상품이 삭제되는 건 아니에요. 네이버에서 재입고되면 바로 "판매재개"할 수 있어요.',
      },
      {
        title: '이미 주문이 들어온 경우 — 대체 상품 검색',
        description: '품절 상품에 주문이 들어왔다면, 먼저 같은 상품을 다른 네이버 셀러에서 찾아보세요.',
        detailedInstructions: [
          '네이버 쇼핑에서 동일 상품명으로 검색하세요.',
          '같은 상품을 판매하는 다른 네이버 셀러를 찾으세요.',
          '가격을 비교하여 마진이 남는지 확인하세요.',
          '발견했다면 해당 셀러에서 구매 후 쿠팡 고객에게 발송하세요.',
          '이 경우 소싱 URL도 새 셀러로 업데이트해두세요.',
        ],
        externalLink: { url: 'https://shopping.naver.com', label: '네이버 쇼핑 검색' },
        tip: '같은 상품이 여러 네이버 셀러에서 판매되는 경우가 많아요. 미리 2~3개 셀러를 파악해두면 품절 시 빠르게 대체할 수 있어요.',
      },
      {
        title: '대체 상품도 없는 경우 — 쿠팡 주문 취소',
        description: '어디서도 구할 수 없다면 쿠팡 주문을 취소 처리합니다.',
        detailedInstructions: [
          '쿠팡 Wing > "주문/배송" > "주문 확인"으로 이동하세요.',
          '해당 주문을 선택하세요.',
          '"주문 취소" 버튼을 클릭하세요.',
          '취소 사유를 "재고 소진"으로 선택하세요.',
          '고객에게 사과 메시지를 발송하세요.',
        ],
        warning: '판매자 귀책 취소는 쿠팡 페널티에 직접 영향을 줘요. 월 취소율 관리가 중요합니다. 취소율이 높아지면 상품 노출이 줄어들어요.',
        copyableTemplates: [
          {
            label: '품절 취소 사과 메시지',
            text: '고객님 안녕하세요.\n\n주문해 주신 [상품명]이 갑작스러운 재고 소진으로 발송이 어렵게 되었습니다.\n\n이에 주문 취소 처리를 도와드렸으며, 결제하신 금액은 전액 환불될 예정입니다.\n\n불편을 끼쳐 대단히 죄송합니다.\n감사합니다.',
          },
        ],
      },
      {
        title: '재발 방지 — 안전재고 관리법',
        description: '품절 사고를 줄이기 위한 습관을 만드세요.',
        detailedInstructions: [
          '판매량이 많은 상품은 네이버 원본 페이지를 "즐겨찾기 폴더"에 정리하세요.',
          '매일 아침 출근 루틴: 즐겨찾기 열어서 품절 여부 확인 (5~10분).',
          '네이버 상품 페이지에 "재입고 알림"이 있으면 설정해두세요.',
          '판매 상위 상품은 대체 소싱처를 미리 2~3개 확보해두세요.',
          '쿠팡 등록 상품 수가 많다면 판매 0건인 상품은 과감히 판매중지하여 관리 범위를 줄이세요.',
        ],
        tip: '상품 100개를 매일 확인하는 건 불가능해요. 최근 7일 판매 실적이 있는 상품만 집중 관리하세요.',
      },
    ],
    faqs: [
      {
        question: '품절 상품을 쿠팡에서 삭제해야 하나요?',
        answer: '삭제하지 마세요! "판매중지"로 처리하면 됩니다. 네이버에서 재입고되면 바로 "판매재개"할 수 있어요. 삭제하면 상품 등록을 처음부터 다시 해야 하고, 기존 리뷰도 없어져요.',
      },
      {
        question: '주문 취소하면 페널티가 바로 오나요?',
        answer: '1~2건으로 바로 큰 페널티가 오진 않아요. 하지만 월간 취소율이 쌓이면 상품 노출 순위가 떨어지고, 심하면 판매 제한을 받을 수 있어요. 월 취소율 2% 이하를 유지하는 게 좋아요.',
      },
      {
        question: '네이버 "일시품절"과 "판매종료"의 차이는?',
        answer: '"일시품절"은 재입고 가능성이 있는 거예요. 며칠 기다리면 다시 판매될 수 있어요. "판매종료"는 해당 셀러가 더 이상 판매하지 않는 거예요. 다른 셀러를 찾거나 쿠팡에서 판매중지하세요.',
      },
    ],
    relatedArticleIds: ['naver-resale-order', 'naver-price-change', 'inventory-management', 'seller-grade-penalty'],
  },

  // ── 2. 네이버→쿠팡 송장 전환 가이드 ──
  {
    articleId: 'naver-courier-mapping',
    categoryId: 'orders-shipping',
    title: '네이버→쿠팡 송장 전환 가이드',
    subtitle: '택배사 코드 매핑부터 발송처리까지 한 번에',
    icon: '🔄',
    estimatedTime: '약 5분',
    overview:
      '네이버에서 구매한 상품이 발송되면 송장번호를 쿠팡에 입력해야 해요. 그런데 네이버와 쿠팡의 택배사 이름/코드가 달라서 헷갈리죠. 택배사 매핑표와 정확한 입력 방법을 알려드립니다.',
    steps: [
      {
        title: '네이버에서 송장 정보 확인',
        description: '네이버 주문의 택배사와 송장번호를 확인합니다.',
        detailedInstructions: [
          '네이버 "내 주문" 페이지에서 해당 주문을 찾으세요.',
          '"배송조회" 버튼을 클릭하세요.',
          '택배사 이름과 송장번호를 정확히 메모하세요.',
          '예시: "CJ대한통운 / 123456789012"',
        ],
        tip: '네이버 앱에서도 확인 가능해요. 앱 > 주문/배송 > 해당 주문 > 배송조회.',
      },
      {
        title: '택배사 코드 매핑 확인',
        description: '네이버 택배사를 쿠팡 택배사로 변환합니다.',
        detailedInstructions: [
          '아래 매핑표를 참고하여 쿠팡에서 선택할 택배사를 확인하세요.',
          '※ 택배사 이름이 같더라도 쿠팡에서의 명칭이 다를 수 있어요.',
          '가장 흔한 매핑:',
          '• CJ대한통운 → 쿠팡: "CJ대한통운"',
          '• 한진택배 → 쿠팡: "한진택배"',
          '• 롯데택배(롯데글로벌로지스) → 쿠팡: "롯데택배"',
          '• 로젠택배 → 쿠팡: "로젠택배"',
          '• 우체국택배 → 쿠팡: "우체국택배"',
          '• 경동택배 → 쿠팡: "경동택배"',
          '• 대신택배 → 쿠팡: "대신택배"',
          '• 일양로지스 → 쿠팡: "일양로지스"',
          '• GSpostbox → 쿠팡: "GS Postbox 택배"',
          '• 쿠팡 자체배송(로켓) → 해당 없음 (아래 FAQ 참고)',
        ],
        copyableTemplates: [
          {
            label: '택배사 매핑표 (전체)',
            text: '📦 네이버 → 쿠팡 택배사 매핑표\n\nCJ대한통운 → CJ대한통운\n한진택배 → 한진택배\n롯데택배(롯데글로벌로지스) → 롯데택배\n로젠택배 → 로젠택배\n우체국택배 → 우체국택배\n경동택배 → 경동택배\n대신택배 → 대신택배\n일양로지스 → 일양로지스\nGSpostbox → GS Postbox 택배\n합동택배 → 합동택배\n천일택배 → 천일택배\n건영택배 → 건영택배',
          },
        ],
        warning: '택배사를 잘못 선택하면 배송 추적이 안 돼요! 고객이 "배송 추적이 안 됩니다"라고 문의할 수 있어요. 반드시 정확한 택배사를 선택하세요.',
      },
      {
        title: '쿠팡 Wing에서 발송처리',
        description: '확인한 송장번호를 쿠팡 Wing에 입력합니다.',
        detailedInstructions: [
          '쿠팡 Wing에 로그인하세요.',
          '"주문/배송" → "주문 확인" 메뉴로 이동하세요.',
          '해당 주문을 찾아 체크박스를 선택하세요.',
          '"발송처리" 버튼을 클릭하세요.',
          '택배사를 드롭다운에서 선택하세요 (위 매핑표 참고).',
          '송장번호를 정확히 입력하세요 (공백, 하이픈 없이 숫자만).',
          '"발송처리 완료"를 클릭하세요.',
        ],
        externalLink: { url: 'https://wing.coupang.com', label: '쿠팡 Wing 바로가기' },
        tip: '송장번호 입력 후 반드시 "배송조회" 버튼으로 정상 추적되는지 확인하세요! 번호가 틀리면 다시 입력해야 해요.',
      },
      {
        title: '발송처리 후 확인사항',
        description: '발송처리가 정상적으로 되었는지 점검합니다.',
        detailedInstructions: [
          '쿠팡 Wing > "주문/배송" > "출고관리"에서 해당 주문이 "배송 중" 상태인지 확인하세요.',
          '"배송조회" 링크를 클릭하여 실제 배송 추적이 되는지 확인하세요.',
          '배송 추적이 안 되면: 송장번호가 틀렸거나 택배사가 잘못 선택된 거예요.',
          '이 경우 "발송 취소" 후 다시 올바른 정보로 발송처리하세요.',
        ],
        warning: '발송처리 후 배송 추적이 안 되는 상태로 방치하면, 고객이 "배송 사고" 문의를 하거나 주문 취소를 요청할 수 있어요.',
      },
    ],
    faqs: [
      {
        question: '네이버 택배사가 쿠팡 목록에 없으면 어떡하나요?',
        answer: '드물지만 소규모 택배사는 쿠팡에 없을 수 있어요. 이 경우 "기타" 택배사를 선택하고 송장번호를 입력하세요. 단, 배송 추적이 안 될 수 있으니 고객에게 미리 안내하는 게 좋아요.',
      },
      {
        question: '송장번호를 잘못 입력했으면 어떡하나요?',
        answer: 'Wing > 출고관리에서 해당 주문의 "발송 취소"를 클릭하고, 다시 올바른 송장번호로 발송처리하면 돼요. 발송 취소 가능 기간은 보통 24시간 이내예요.',
      },
      {
        question: '하나의 네이버 주문에서 분할 발송된 경우는요?',
        answer: '네이버 셀러가 상품을 나눠서 보내면 송장이 2개 이상 나올 수 있어요. 쿠팡에는 송장 1개만 입력 가능하니, 메인 상품의 송장을 먼저 입력하고 나머지는 고객에게 "별도 배송 건이 있습니다"라고 메시지를 보내세요.',
      },
      {
        question: '네이버 로켓배송(쿠팡 로켓) 상품을 소싱한 건 아닌데, "쿠팡 자체배송"이 뭔가요?',
        answer: '네이버에서 소싱한 거면 "쿠팡 자체배송"은 해당 없어요. 네이버 셀러가 보내는 택배사(CJ대한통운, 한진 등)를 선택하세요. "쿠팡 자체배송"은 로켓배송 전용이에요.',
      },
    ],
    relatedArticleIds: ['coupang-invoice', 'naver-resale-order', 'naver-shipping-delay'],
  },

  // ── 3. 배송 지연 대처법 ──
  {
    articleId: 'naver-shipping-delay',
    categoryId: 'orders-shipping',
    title: '배송 지연 대처법',
    subtitle: '네이버 판매자 늦은 발송 시 쿠팡 페널티 방지하는 방법',
    icon: '⏰',
    estimatedTime: '약 8분',
    overview:
      '네이버에서 주문했는데 판매자가 발송을 안 해요. 쿠팡에는 주문이 들어와 있고, 발송 기한은 다가오고... 이럴 때 어떻게 해야 하는지 단계별로 알려드립니다. 핵심은 "빨리 알아채고, 빨리 대응하는 것"이에요.',
    steps: [
      {
        title: '쿠팡 발송 기한 확인',
        description: '먼저 쿠팡에서 요구하는 발송 기한을 정확히 파악하세요.',
        detailedInstructions: [
          '쿠팡 Wing > "주문/배송" > "주문 확인"에서 해당 주문을 찾으세요.',
          '"발송기한"을 확인하세요. 보통 주문 확인 후 48시간(영업일 기준)이에요.',
          '발송기한까지 남은 시간을 계산하세요.',
          '주말/공휴일은 영업일에 포함되지 않아요.',
        ],
        warning: '발송기한을 넘기면 "배송 지연" 페널티가 부과돼요. 누적되면 상품 노출 감소, 심하면 판매 제한까지 갈 수 있어요.',
      },
      {
        title: '네이버 주문 발송 상태 확인',
        description: '네이버에서 구매한 주문의 현재 상태를 확인합니다.',
        detailedInstructions: [
          '네이버 "내 주문"에서 해당 주문을 찾으세요.',
          '주문 상태를 확인하세요:',
          '• "결제완료" / "상품 준비 중" → 아직 발송 안 됨',
          '• "배송 중" → 발송됨! 송장번호 확인 가능',
          '• "배송완료" → 이미 도착',
          '"결제완료" 상태가 24시간 이상 지속되면 위험 신호예요.',
        ],
      },
      {
        title: '네이버 판매자에게 발송 독촉',
        description: '발송이 지연되고 있다면 네이버 판매자에게 연락하세요.',
        detailedInstructions: [
          '네이버 해당 주문에서 "판매자에게 문의" 버튼을 클릭하세요.',
          '정중하지만 명확하게 발송 일정을 물어보세요.',
          '답변이 없으면 네이버 "고객센터"에 문의하세요.',
        ],
        copyableTemplates: [
          {
            label: '발송 독촉 메시지',
            text: '안녕하세요.\n\n[날짜]에 주문한 [상품명] 건입니다.\n주문한 지 [N]일이 지났는데 아직 발송이 안 된 것 같아 문의드립니다.\n\n오늘 중으로 발송이 가능한지 확인 부탁드립니다.\n급하게 필요한 상품이라 빠른 확인 부탁드려요.\n\n감사합니다.',
          },
        ],
        tip: '네이버 판매자 대부분은 영업일 기준 1~2일 내 답변해요. 하지만 답변이 늦을 수 있으니, 독촉과 동시에 아래 대비책도 준비하세요.',
      },
      {
        title: '발송기한 임박 시 — 대비책 실행',
        description: '쿠팡 발송기한까지 12시간 이내라면 즉시 대비하세요.',
        detailedInstructions: [
          '방법 1: 같은 상품을 다른 네이버 셀러에서 추가 구매 (빠른 배송 가능한 곳)',
          '→ 기존 네이버 주문은 나중에 도착하면 반품 처리',
          '방법 2: 쿠팡에서 같은 상품을 직접 구매하여 고객에게 발송',
          '→ 마진은 날리지만 페널티는 피할 수 있음',
          '방법 3: 불가피하면 쿠팡 주문 취소',
          '→ 고객에게 사과 메시지 + 쿠팡 주문 취소 처리',
          '→ 이건 최후의 수단! 취소 페널티가 발생해요.',
        ],
        warning: '발송기한을 넘기는 것보다 주문 취소가 페널티가 더 적을 수 있어요. 상황에 따라 판단하세요.',
      },
      {
        title: '재발 방지 — 발송 빠른 셀러 선별법',
        description: '앞으로 소싱할 때 발송이 빠른 네이버 셀러를 고르는 방법입니다.',
        detailedInstructions: [
          '네이버 상품 페이지에서 "배송 안내"를 확인하세요.',
          '"오늘출발", "내일도착" 마크가 있는 상품 우선 선택!',
          '판매자 정보에서 "평균 발송 소요일"을 확인하세요.',
          '리뷰에서 "배송 빠름" 언급이 많은 셀러를 선택하세요.',
          '테스트 주문을 해서 실제 발송 속도를 확인해보는 것도 좋아요.',
        ],
        tip: '쿠팡 배송약속일을 설정할 때, 네이버 소싱 상품은 넉넉하게 3~5일로 설정하세요. 당일/익일 배송으로 설정하면 지연 위험이 매우 높아요!',
      },
      {
        title: '쿠팡 배송약속일 안전하게 설정하기',
        description: '상품 등록 시 배송약속일을 넉넉하게 잡아 지연 위험을 줄이세요.',
        detailedInstructions: [
          '쿠팡 Wing > 상품 등록/수정 > "출고 소요일"을 설정하세요.',
          '네이버 소싱 상품: 3일 이상으로 설정하는 게 안전해요.',
          '네이버 발송 1~2일 + 배송 1~2일 = 최소 3일은 필요.',
          '주말이 끼면 더 길어질 수 있으니 여유 있게 설정하세요.',
          '너무 길게 잡으면 고객이 안 사니까, 3~5일이 적당해요.',
        ],
        warning: '출고 소요일을 "당일" 또는 "1일"로 설정하고 네이버 소싱을 하면, 거의 확실히 배송 지연 페널티를 받게 돼요.',
      },
    ],
    faqs: [
      {
        question: '쿠팡 발송기한을 넘기면 바로 페널티를 받나요?',
        answer: '네, "배송 지연" 건수로 집계돼요. 1건으로 큰 문제가 되진 않지만, 월간 지연율이 높아지면 상품 노출 감소, 아이템위너 박탈, 심하면 판매 제한까지 갈 수 있어요.',
      },
      {
        question: '네이버 주문을 취소하면 불이익이 있나요?',
        answer: '네이버 구매자로서 주문을 취소하는 건 불이익 없어요. 발송 전이면 바로 취소 가능하고, 발송 후라면 반품 절차를 밟으면 됩니다.',
      },
      {
        question: '쿠팡에서 "발송 지연 사유"를 입력하면 페널티가 줄어드나요?',
        answer: '사유를 입력하면 기록은 남지만, 페널티 자체가 면제되지는 않아요. 그래도 입력하는 게 좋아요. 반복될 경우 쿠팡 측에서 참고할 수 있거든요.',
      },
    ],
    relatedArticleIds: ['naver-courier-mapping', 'naver-resale-order', 'seller-grade-penalty', 'naver-stockout-handling'],
  },

  // ── 4. 네이버 리셀 반품 연동 처리 ──
  {
    articleId: 'naver-resale-return',
    categoryId: 'returns-cs',
    title: '네이버 리셀 반품 처리',
    subtitle: '쿠팡 고객 반품 → 네이버 반품 연동하는 전체 과정',
    icon: '🔁',
    estimatedTime: '약 15분',
    overview:
      '쿠팡 고객이 반품을 요청했어요. 문제는 이 상품이 네이버에서 소싱한 거라서, 쿠팡 반품 처리 + 네이버 반품 처리를 둘 다 해야 한다는 거예요. 시간이 지나면 네이버 반품 기한이 넘어가니까 빠르게 처리하는 것이 핵심입니다.',
    steps: [
      {
        title: '쿠팡 반품 요청 확인',
        description: '쿠팡 Wing에서 반품 요청 내용을 확인합니다.',
        detailedInstructions: [
          '쿠팡 Wing > "주문/배송" > "반품관리"로 이동하세요.',
          '신규 반품 요청을 확인하세요.',
          '반품 사유, 상품명, 주문번호, 주문일을 메모하세요.',
          '특히 "주문일"을 꼭 기록하세요. 네이버 반품 기한 계산에 필요해요.',
        ],
        externalLink: { url: 'https://wing.coupang.com', label: '쿠팡 Wing 바로가기' },
        tip: '반품 요청이 들어오면 최대한 빨리 확인하세요! 네이버 반품 기한(7일)을 놓치면 자비 부담이 돼요.',
      },
      {
        title: '네이버 반품 기한 확인',
        description: '네이버 원본 주문의 반품 가능 여부와 기한을 확인합니다.',
        detailedInstructions: [
          '네이버 "내 주문"에서 해당 원본 주문을 찾으세요.',
          '수령일(배송완료일)을 확인하세요.',
          '단순 변심: 수령 후 7일 이내 반품 가능',
          '상품 불량: 수령 후 3개월 이내 반품 가능',
          '현재 날짜와 비교하여 반품 기한이 남았는지 확인하세요.',
          '⚠️ 쿠팡 반품 수거 → 셀러 도착까지 2~3일 걸리니까, 실제로는 더 빠듯해요!',
        ],
        warning: '네이버 반품 기한은 "수령일 기준"이에요. 쿠팡 고객이 반품 요청한 날이 아니라, 내가 네이버에서 상품을 수령한 날 기준이에요. 보통 네이버 상품은 쿠팡 고객에게 직배송하니까, 쿠팡 고객이 수령한 날 ≒ 네이버 수령일이에요.',
      },
      {
        title: '반품 사유 매핑',
        description: '쿠팡 반품 사유를 네이버 반품 사유로 변환합니다.',
        detailedInstructions: [
          '쿠팡과 네이버의 반품 사유 명칭이 달라요. 아래를 참고하세요:',
          '• 쿠팡 "단순 변심" → 네이버 "구매의사 취소" 또는 "색상/사이즈 변경"',
          '• 쿠팡 "상품 불량/파손" → 네이버 "상품 불량/파손"',
          '• 쿠팡 "상품 상세 불일치" → 네이버 "상품 정보 상이"',
          '• 쿠팡 "오배송" → 네이버 "오배송"',
          '• 쿠팡 "배송 지연" → 네이버 "기타 사유" (배송 지연 명시)',
        ],
        copyableTemplates: [
          {
            label: '반품 사유 매핑표',
            text: '📋 쿠팡→네이버 반품 사유 매핑\n\n쿠팡 "단순 변심" → 네이버 "구매의사 취소"\n쿠팡 "상품 불량/파손" → 네이버 "상품 불량/파손"\n쿠팡 "상품 상세 불일치" → 네이버 "상품 정보 상이"\n쿠팡 "오배송" → 네이버 "오배송"\n쿠팡 "배송 지연" → 네이버 "기타" (배송 지연 기재)',
          },
        ],
        tip: '네이버 반품 사유를 잘 선택하면 반품 배송비를 네이버 판매자에게 부담시킬 수 있어요. "상품 불량"이면 판매자 부담, "변심"이면 구매자(나) 부담이에요.',
      },
      {
        title: '쿠팡 반품 승인 + 수거 진행',
        description: '쿠팡에서 반품을 승인하고 고객에게서 상품을 수거합니다.',
        detailedInstructions: [
          '쿠팡 Wing > 반품관리에서 "반품 승인"을 클릭하세요.',
          '수거 방법 선택: 자동 수거 (택배사 배정) 또는 자체 수거.',
          '자동 수거를 선택하면 택배기사가 고객에게 방문합니다.',
          '수거 완료까지 보통 2~3일 소요.',
          '⚠️ 수거 주소가 내 주소인지 확인하세요! (직배송한 경우 고객 주소에서 바로 네이버 판매자에게 보낼 수 없어요)',
        ],
        warning: '리셀 상품은 반드시 "내 주소"로 수거해야 해요. 고객에게서 받은 상품을 네이버 판매자에게 다시 반품 보내야 하거든요.',
      },
      {
        title: '상품 수령 후 네이버 반품 접수',
        description: '쿠팡 고객에게서 상품을 수령한 후, 네이버에 반품을 접수합니다.',
        detailedInstructions: [
          '쿠팡 반품 상품이 내 주소로 도착하면 상태를 확인하세요.',
          '상품 상태가 양호하면 → 네이버에서 반품 접수하세요.',
          '네이버 "내 주문" > 해당 주문 > "반품 신청" 클릭.',
          '반품 사유 선택 (위 매핑표 참고).',
          '수거 방법: "판매자 지정 택배" 선택 (판매자가 택배기사 보내줘요).',
          '반품 접수 완료!',
        ],
        tip: '쿠팡에서 상품 수령 즉시 네이버 반품을 접수하세요. 하루라도 빨리 해야 기한 초과 위험이 줄어요.',
      },
      {
        title: '쿠팡 환불 처리',
        description: '쿠팡 고객에 대한 환불을 처리합니다.',
        detailedInstructions: [
          '쿠팡 Wing > 반품관리에서 수거 완료된 건을 확인하세요.',
          '"환불 처리" 버튼을 클릭하세요.',
          '전액 환불 또는 부분 환불을 선택하세요.',
          '환불이 처리되면 고객에게 자동 알림이 갑니다.',
        ],
      },
      {
        title: '네이버 반품 기한 초과 시 대처',
        description: '네이버 반품 기한을 넘겼다면 이렇게 대처하세요.',
        detailedInstructions: [
          '기한 초과해도 포기하지 마세요! 아래 방법을 시도하세요.',
          '방법 1: 네이버 판매자에게 직접 연락',
          '→ "반품 기한이 약간 초과되었는데, 반품 처리 가능한가요?" 문의',
          '→ 대부분의 판매자는 며칠 초과 정도는 수용해줘요.',
          '방법 2: 네이버 고객센터에 문의',
          '→ 상품 불량인 경우 기한이 넉넉하니 (3개월) 이 사유로 접수 시도.',
          '방법 3: 자체 손실 처리',
          '→ 반품을 포기하고, 상품을 중고로 재판매하거나 개인 사용.',
          '→ 이 비용은 리셀의 "사업 리스크"로 감안해야 해요.',
        ],
        copyableTemplates: [
          {
            label: '네이버 판매자 반품 요청 메시지',
            text: '안녕하세요.\n\n[날짜]에 구매한 [상품명] 건으로 문의드립니다.\n\n수령 후 확인이 늦어져 반품 접수가 약간 지연되었습니다.\n상품은 미사용/미개봉 상태이며, 반품 처리가 가능한지 여쭤봅니다.\n\n반품 배송비는 제가 부담하겠습니다.\n확인 부탁드립니다. 감사합니다.',
          },
        ],
        warning: '네이버 반품을 못 하면 그 비용은 고스란히 내 손실이에요. 그래서 쿠팡 반품 접수 즉시 네이버 반품 기한을 확인하는 습관이 중요해요!',
      },
    ],
    faqs: [
      {
        question: '쿠팡 고객이 반품하는데 네이버 반품 기한이 지나면 어떡하나요?',
        answer: '쿠팡 고객 환불은 해줘야 해요 (쿠팡 정책상 의무). 네이버 반품을 못 하면 그 차액은 내 손실이에요. 리셀의 가장 큰 리스크 중 하나입니다. 이런 손실을 줄이려면 소싱할 때 "반품이 적은 상품"을 선택하는 게 중요해요.',
      },
      {
        question: '반품 배송비는 누가 내나요?',
        answer: '쿠팡 측 반품 배송비: 고객 변심이면 고객 부담, 상품 불량이면 판매자(나) 부담. 네이버 측 반품 배송비: 변심이면 구매자(나) 부담, 불량이면 판매자 부담. 최악의 경우 양쪽 모두 내가 부담할 수 있어요.',
      },
      {
        question: '반품 상품이 파손되어 돌아왔으면요?',
        answer: '쿠팡 고객에게는 부분 환불 처리하세요 (증거 사진 필수). 네이버 판매자에게는 "상품 불량" 사유로 반품 접수하세요. 양쪽 모두 증거 사진을 확보하는 게 핵심이에요.',
      },
    ],
    relatedArticleIds: ['coupang-return', 'naver-resale-exchange', 'difficult-customer', 'naver-resale-order'],
  },

  // ── 5. 네이버 리셀 교환 처리 ──
  {
    articleId: 'naver-resale-exchange',
    categoryId: 'returns-cs',
    title: '네이버 리셀 교환 처리',
    subtitle: '쿠팡 고객 교환 요청 시 반품+재주문 처리 방법',
    icon: '🔃',
    estimatedTime: '약 12분',
    overview:
      '쿠팡 고객이 "사이즈 교환" 또는 "색상 교환"을 요청했어요. 하지만 네이버 소싱이라서 바로 교환이 안 되고, 반품 + 새 주문이라는 2단계 작업이 필요해요. 복잡하지만, 순서대로 하면 어렵지 않아요.',
    steps: [
      {
        title: '쿠팡 교환 요청 확인',
        description: '어떤 상품의 어떤 옵션으로 교환을 원하는지 확인합니다.',
        detailedInstructions: [
          '쿠팡 Wing > "주문/배송" > "반품관리" 또는 "교환관리"에서 요청을 확인하세요.',
          '고객이 원하는 교환 옵션을 정확히 메모하세요.',
          '예: "265mm → 270mm" 또는 "블랙 → 화이트"',
          '쿠팡에서는 교환 = 반품 + 재구매 형태로 처리돼요.',
        ],
      },
      {
        title: '교환 가능 여부 판단',
        description: '원하는 옵션이 네이버에서 구매 가능한지 확인합니다.',
        detailedInstructions: [
          '네이버에서 해당 상품 페이지를 열어보세요.',
          '고객이 원하는 옵션(사이즈, 색상 등)이 재고가 있는지 확인하세요.',
          '재고 있음 → 교환 가능! 다음 단계로 진행하세요.',
          '재고 없음 → 고객에게 "교환 불가 안내" + 반품 환불로 전환하세요.',
        ],
        copyableTemplates: [
          {
            label: '교환 불가 안내 메시지',
            text: '고객님 안녕하세요.\n\n교환 요청하신 [상품명]의 [원하는 옵션]이 현재 재고가 소진되어 교환이 어려운 상황입니다.\n\n대신 반품 환불 처리를 도와드리겠습니다.\n반품 접수를 진행해 드릴까요?\n\n불편을 끼쳐 죄송합니다.',
          },
        ],
      },
      {
        title: '네이버에서 새 옵션 상품 주문',
        description: '교환할 옵션으로 네이버에서 새로 주문합니다.',
        detailedInstructions: [
          '네이버에서 해당 상품의 교환 희망 옵션을 선택하세요.',
          '배송지를 쿠팡 고객의 주소로 입력하세요.',
          '결제를 완료하세요.',
          '주문번호를 메모해두세요.',
        ],
        warning: '반드시 쿠팡 고객 주소로 배송지를 설정하세요! 교환 상품은 고객에게 직배송해야 해요.',
      },
      {
        title: '쿠팡 교환 발송처리',
        description: '네이버 새 주문의 송장번호로 쿠팡에서 교환 발송처리를 합니다.',
        detailedInstructions: [
          '네이버에서 새 주문이 발송되면 송장번호를 확인하세요.',
          '쿠팡 Wing > 교환관리에서 해당 건의 "교환 발송처리"를 클릭하세요.',
          '택배사를 매핑해서 선택하고 (네이버→쿠팡 택배사 매핑 가이드 참고), 송장번호를 입력하세요.',
          '발송처리 완료!',
        ],
        tip: '새 주문 발송 후 쿠팡 교환 발송처리를 바로 하세요. 교환 발송기한이 있어요!',
      },
      {
        title: '기존 상품 반품 수거',
        description: '고객에게서 기존 상품을 수거합니다.',
        detailedInstructions: [
          '쿠팡에서 교환 수거가 자동 진행됩니다.',
          '수거된 상품이 내 주소로 도착하면 상태를 확인하세요.',
          '이 상품은 네이버에서 반품 처리하세요 (네이버 리셀 반품 처리 가이드 참고).',
          '또는 상태가 양호하면 재판매용으로 보관하세요.',
        ],
      },
      {
        title: '비용 정리',
        description: '교환 건의 총 비용을 정리합니다.',
        detailedInstructions: [
          '교환 시 발생하는 비용을 파악하세요:',
          '• 새 상품 구매비 (네이버에서 새로 주문한 금액)',
          '• 반품 배송비 (고객→나, 사유에 따라 부담 주체 다름)',
          '• 네이버 반품 배송비 (나→네이버 판매자)',
          '이 비용이 마진을 초과하면 손해 보는 거예요.',
          '교환이 잦은 상품(의류, 신발 등)은 리셀 시 주의하세요!',
        ],
        tip: '사이즈/색상이 중요한 의류, 신발 같은 상품은 교환율이 높아요. 이런 카테고리는 리셀 시 교환 비용을 감안한 마진 설정이 필요해요.',
      },
    ],
    faqs: [
      {
        question: '교환 대신 반품+재주문을 고객에게 요청해도 되나요?',
        answer: '가능하지만 권장하지 않아요. 고객 입장에서는 불편하고, 별점이 낮아질 수 있어요. 직접 교환 처리를 해주는 게 리뷰 관리에 좋아요.',
      },
      {
        question: '교환 비용이 마진보다 크면 어떡하나요?',
        answer: '안타깝지만 리셀의 리스크예요. 이런 손실을 줄이려면: (1) 교환율이 낮은 상품 위주로 소싱, (2) 상세페이지에 사이즈/색상 정보를 정확히 기재, (3) 마진 설정 시 교환 비용 5~10% 감안.',
      },
      {
        question: '쿠팡에서 교환 기한은 얼마나 되나요?',
        answer: '교환 발송은 보통 교환 접수 후 3~5영업일 이내에 처리해야 해요. 기한 초과 시 자동으로 환불 처리될 수 있으니 빠르게 진행하세요.',
      },
    ],
    relatedArticleIds: ['naver-resale-return', 'coupang-return', 'naver-courier-mapping', 'naver-resale-order'],
  },

  // ── 6. 네이버 원가 변동 대처법 ──
  {
    articleId: 'naver-price-change',
    categoryId: 'revenue-settlement',
    title: '네이버 원가 변동 대처법',
    subtitle: '소싱 가격이 변동될 때 마진을 지키는 방법',
    icon: '📊',
    estimatedTime: '약 8분',
    overview:
      '네이버에서 소싱하는 상품의 가격이 수시로 바뀌어요. 올라가면 마진이 줄거나 손해를 보고, 내려가면 더 벌 기회가 생기죠. 가격 변동을 빨리 발견하고, 쿠팡 판매가를 조정하는 방법을 알려드립니다.',
    steps: [
      {
        title: '원가 관리 시트 만들기',
        description: '등록한 모든 상품의 원가를 한눈에 관리할 수 있는 시트를 만드세요.',
        detailedInstructions: [
          '엑셀 또는 구글 스프레드시트를 열어주세요.',
          '다음 열(컬럼)을 만드세요:',
          '• 상품명 | 네이버 URL | 등록일 원가 | 현재 원가 | 쿠팡 판매가 | 쿠팡 수수료 | 순마진 | 마진율 | 상태',
          '쿠팡에 등록한 모든 상품의 정보를 입력하세요.',
          '이 시트가 당신의 "마진 관리 대시보드"가 됩니다.',
        ],
        copyableTemplates: [
          {
            label: '마진 관리 시트 헤더 (복사용)',
            text: '상품명\t네이버 URL\t등록일 원가\t현재 원가\t쿠팡 판매가\t쿠팡 수수료(10.8%)\t순마진\t마진율\t상태\t최종 확인일',
          },
          {
            label: '마진 계산 공식 (구글시트)',
            text: '순마진 = 쿠팡 판매가 - (쿠팡 판매가 × 10.8%) - 네이버 원가\n마진율 = 순마진 / 쿠팡 판매가 × 100\n\n구글시트 수식 예시:\n순마진: =E2-(E2*0.108)-D2\n마진율: =G2/E2*100',
          },
        ],
        tip: '구글 스프레드시트를 쓰면 폰에서도 확인할 수 있어요. 외출 중에도 가격 체크가 가능해요.',
      },
      {
        title: '정기 가격 확인 루틴 만들기',
        description: '매일 또는 2~3일마다 네이버 원가를 확인하는 습관을 만드세요.',
        detailedInstructions: [
          '매일 아침 시간을 정해두세요 (예: 오전 9시, 10분).',
          '판매 상위 상품부터 네이버 원본 페이지를 열어 현재 가격을 확인하세요.',
          '시트에 "현재 원가"를 업데이트하세요.',
          '마진율이 변화한 상품을 확인하세요.',
          '• 마진율 10% 이하 → 가격 조정 필요',
          '• 마진율 0% 이하 → 즉시 쿠팡 가격 인상 또는 판매중지',
          '• 마진율 상승 → 쿠팡 가격 인하로 경쟁력 확보 가능',
        ],
        tip: '상품이 50개 이상이면 전부 확인하기 힘들어요. 최근 7일 판매 있는 상품 + 마진 15% 이하 상품만 우선 확인하세요.',
      },
      {
        title: '원가 상승 시 — 쿠팡 판매가 조정',
        description: '네이버 원가가 올라서 마진이 줄었을 때 대응합니다.',
        detailedInstructions: [
          '먼저 마진이 아직 남는지 확인하세요:',
          '순마진 = 쿠팡 판매가 - (쿠팡 판매가 × 수수료율) - 새 원가',
          '마진이 남지만 줄었다면:',
          '→ 쿠팡 Wing에서 판매가를 인상하세요.',
          '→ 단, 경쟁 상품 가격도 확인! 너무 비싸면 안 팔려요.',
          '마진이 마이너스라면:',
          '→ 즉시 판매중지! 팔면 팔수록 손해.',
          '→ 가격이 다시 내려올 때까지 기다리거나, 상품을 내리세요.',
        ],
        warning: '마진이 마이너스인 상품을 방치하면, 주문이 들어올 때마다 손해가 쌓여요. 발견 즉시 판매중지하세요!',
      },
      {
        title: '원가 하락 시 — 기회 활용',
        description: '네이버 원가가 내려갔을 때 활용하는 방법입니다.',
        detailedInstructions: [
          '원가가 내려가면 2가지 선택지가 있어요:',
          '① 쿠팡 가격 유지 → 마진 상승! 더 많이 벌어요.',
          '② 쿠팡 가격 인하 → 가격 경쟁력 확보! 더 많이 팔아요.',
          '추천: 경쟁이 치열한 상품은 ②, 독점적 상품은 ①.',
          '가격 인하 시 쿠팡 Wing > 상품 수정 > 판매가 변경.',
        ],
        tip: '네이버에서 할인/프로모션을 할 때 원가가 일시적으로 떨어지는 경우가 있어요. 이때 몰아서 구매해두면 마진을 극대화할 수 있지만, 재고 리스크가 있으니 신중하게!',
      },
      {
        title: '마진율 기준 설정하기',
        description: '나만의 마진 기준을 세워 기계적으로 판단하세요.',
        detailedInstructions: [
          '감이 아니라 기준으로 판단하는 게 중요해요.',
          '권장 마진 기준:',
          '• 마진율 20% 이상 → 안전 (유지)',
          '• 마진율 10~20% → 주의 (가격 모니터링 강화)',
          '• 마진율 5~10% → 위험 (가격 인상 검토)',
          '• 마진율 5% 미만 → 즉시 조치 (가격 인상 또는 판매중지)',
          '• 마진율 0% 이하 → 판매중지 (즉시!)',
          '이 기준을 시트에 조건부 서식(색상)으로 넣으면 한눈에 보여요.',
        ],
        copyableTemplates: [
          {
            label: '구글시트 조건부 서식 (마진율 색상)',
            text: '마진율 열(H열)에 조건부 서식 적용:\n\n초록: H열 > 20  (안전)\n노랑: H열 10~20 (주의)\n주황: H열 5~10 (위험)\n빨강: H열 < 5 (즉시 조치)\n\n구글시트: 서식 > 조건부 서식 > 사용자 지정 수식\n=H2>20 → 초록 배경\n=AND(H2>=10, H2<=20) → 노랑 배경\n=AND(H2>=5, H2<10) → 주황 배경\n=H2<5 → 빨강 배경',
          },
        ],
      },
    ],
    faqs: [
      {
        question: '쿠팡 카테고리별 수수료율은 어떻게 확인하나요?',
        answer: '쿠팡 Wing > 정산 > 수수료 안내에서 확인할 수 있어요. 카테고리마다 5%~15%로 다양해요. 보통 10.8%를 기본으로 계산하지만, 정확한 수수료율은 상품 카테고리에 따라 달라요.',
      },
      {
        question: '네이버 가격이 수시로 바뀌면 쿠팡 가격도 계속 바꿔야 하나요?',
        answer: '매번 바꿀 필요는 없어요. 마진이 기준 이하로 떨어질 때만 조정하세요. 소폭 변동(1~2%)은 무시해도 돼요. 큰 변동(10% 이상)이 있을 때만 대응하면 됩니다.',
      },
      {
        question: '쿠팡에서 가격을 올리면 판매량이 줄지 않나요?',
        answer: '약간의 인상(5~10%)은 판매량에 큰 영향을 주지 않는 경우가 많아요. 대신 경쟁 상품 가격을 꼭 확인하세요. 경쟁 상품보다 많이 비싸지면 판매량이 확실히 줄어요.',
      },
      {
        question: '마진이 안 나는 상품은 그냥 삭제해야 하나요?',
        answer: '삭제하지 말고 "판매중지"하세요. 나중에 네이버 가격이 다시 내려가면 판매를 재개할 수 있어요. 삭제하면 리뷰와 판매 이력이 다 날아가요.',
      },
    ],
    relatedArticleIds: ['naver-stockout-handling', 'coupang-settlement', 'naver-resale-order', 'inventory-management'],
  },
