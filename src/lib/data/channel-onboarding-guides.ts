...
const coupang: OnboardingGuide = {
  ...
  steps: [
    ...
    },
    {
      stepNumber: 3,
      hotspots: [
        { n: 1, x: 24, y: 8, label: '가입 직후에는 "입점 대기상태"입니다. 아직 상품을 팔 수 없어요.' },
        { n: 2, x: 50, y: 43, label: '[사업자 인증하기]를 눌러 정보 입력을 시작하세요.' },
      ],
      title: '사업자 인증 — 정보 입력',
      description: '쿠팡윙 메인의 [사업자 인증하기]로 사업자 정보를 입력합니다.',
      url: 'https://wing.coupang.com',
      detailedInstructions: [
        '쿠팡윙 메인 우측 [사업자 인증하기] 클릭 (가입 직후엔 "입점 대기상태"로 표시됩니다)',
        '사업자등록번호·대표자명·정산계좌는 각각 옆의 [인증하기]를 눌러야 통과합니다',
        '사업장주소는 통신판매업신고증 주소와 글자 그대로 동일하게 입력',
        '비즈니스 형태·대표 카테고리 선택 후 [제출하기]',
      ],
      warning: '사업자등록증과 통신판매업신고증의 주소·상호가 서로 다르면 반려됩니다. 문서 글자 그대로 일치시키세요.',
      tip: '한 번에 다 못 채워도 [임시저장]이 있어 나중에 이어서 할 수 있어요.',
      screen: {
        variant: 'form',
    ...
    },
    {
      stepNumber: 4,
      hotspots: [
        { n: 1, x: 23, y: 25, label: '사업자등록번호를 입력하고 [인증하기]를 눌러야 아래 상호가 채워집니다.' },
        { n: 2, x: 19, y: 47, label: '사업장 주소는 통신판매업신고증과 똑같이 입력하세요. 다르면 반려됩니다.' },
        { n: 3, x: 17, y: 67, label: '[구매안전서비스 이용 확인증 다운로드] — 통신판매업 신고에 필요한 서류를 여기서 받습니다.' },
        { n: 4, x: 14, y: 71, label: '[신청하러가기]로 민원24에서 통신판매업 신고를 하고, 받은 번호를 위 칸에 입력하세요.' },
        { n: 5, x: 42, y: 97, label: '개인정보 동의 체크 후 [제출하기]. 다 못 채웠으면 [임시저장]으로 저장해두세요.' },
      ],
      title: '통신판매업 신고번호 입력 (구매안전서비스 확인증 받기)',
      description: '사업자등록증·통신판매업신고증·통장사본을 올리고 승인 요청.',
      detailedInstructions: [
        '통신판매업 신고가 아직이면 이 화면에서 [구매안전서비스 이용 확인증 다운로드]를 먼저 받으세요',
        '받은 확인증으로 민원24(정부24)에서 통신판매업 신고 → 화면의 [신청하러가기] 버튼으로 바로 이동',
        '발급받은 통신판매업신고번호를 입력칸에 입력',
        '개인정보 수집·이용 동의 체크 후 [제출하기]',
      ],
      warning: '반려 1위 사유가 구매안전서비스 이용확인증 문제입니다. 이 확인증은 쿠팡 화면에서 직접 받아 민원24 신고에 쓰는 것이라 순서가 중요해요 — 확인증 다운로드 → 통신판매업 신고 → 신고번호 입력.',
      tip: '쿠팡은 사업자등록번호·계좌를 번호 인증으로 확인하므로 서류 파일을 미리 올리지 않습니다. 추가 서류가 필요하면 심사 중 별도로 요청됩니다. 정산계좌는 반드시 대표자 명의여야 합니다.',
      screen: {
        variant: 'upload',
...
const naver: OnboardingGuide = {
  ...
  steps: [
    ...
    },
    {
      stepNumber: 7,
      hotspots: [
        { n: 1, x: 59, y: 39, label: '스토어 이름 1~14자. 네이버 검색어로 쓰이니 상품군 단어를 넣으면 유리합니다. 가입 후 1회만 수정 가능.' },
        { n: 2, x: 59, y: 55, label: '스토어 URL 2~30자 영문 소문자. 한 번 정하면 절대 못 바꿉니다 — 오타 주의.' },
        { n: 3, x: 59, y: 68, label: '소개글 50자. 네이버 검색 결과에 설명글로 그대로 노출됩니다. 언제든 수정 가능.' },
        { n: 4, x: 59, y: 80, label: '고객센터 번호는 구매자에게 공개됩니다. 개인 휴대폰을 넣을지 신중히.' },
      ],
      title: '스토어 정보 · 배송/정산 정보',
      description: '스토어명·URL·소개, 출고/반품지, 정산계좌를 입력합니다.',
      detailedInstructions: [
        '스마트스토어 이름: 1~14자(한글·영문·숫자). 네이버 검색 시 검색어로 활용되고, 가입 후 1회만 수정 가능',
        '스마트스토어 URL: 2~30자 영문 소문자·숫자·(-, _). smartstore.naver.com/뒤에 붙는 고유 주소이며 가입 후 수정 불가',
        '소개글: 50자 내외. 네이버 검색 결과의 사이트 설명글로 노출되며 항시 수정 가능',
        '고객센터 전화번호: 스토어 프로필·하단·구매자 주문내역에 상시 노출됩니다',
        '출고지·반품/교환지 주소 입력',
        '정산계좌: 개인은 본인 명의, 사업자는 대표자/사업자 명의 통장',
        '담당자 이메일 인증번호 입력으로 마무리',
      ],
      warning: '스토어 URL은 절대 변경 불가, 스토어명은 딱 1회만 변경 가능 — 오타·급조 금지! 고객센터 번호는 구매자에게 그대로 공개되므로 개인 휴대폰을 넣을지 신중히 정하세요.',
      tip: '스토어명이 곧 검색어이고 소개글이 곧 검색결과 설명입니다. 팔려는 상품군의 단어를 자연스럽게 넣으면 검색 유입에 유리해요.',
      screen: {
        variant: 'form',
        screenTitle: '스토어 정보',
        fields: [
    ...
    },
    {
      stepNumber: 8,
      hotspots: [
        { n: 1, x: 62, y: 24, label: '이것이 "구매안전서비스 이용 확인증" — 통신판매업 신고에 필요한 서류입니다.' },
        { n: 2, x: 62, y: 73, label: '네이버파이낸셜이 발행합니다. 다운로드해서 정부24 신고 때 제출하세요.' },
        { n: 3, x: 87, y: 6, label: '우측 상단 다운로드/인쇄 버튼으로 PDF를 저장하세요.' },
      ],
      title: '서류 제출 · 통신판매업 신고 · 심사',
      description: '서류를 첨부하고 통신판매업 신고번호까지 등록하면 최종 승인.',
      detailedInstructions: [
        '사업자등록증·통장 사본 등 첨부 (신청 후 14일 이내 제출)',
        '통신판매업 미신고면 [판매자정보]에서 "구매안전서비스 이용확인증"을 발급받으세요 (네이버파이낸셜이 발행하는 PDF입니다)',
        '그 PDF를 들고 정부24에서 통신판매업 신고 → 신고번호를 받습니다',
...
const elevenst: OnboardingGuide = {
  ...
  documents: ['사업자등록증', '통신판매업신고증', '대표자 명의 통장사본(개인사업자는 대표자 통장)', '인감증명서 또는 본인서명사실확인서 (최근 3개월 이내 발급분)'],
  ...
  steps: [
    ...
    },
    {
      ...
      detailedInstructions: [
        ...
        '⚠️ 선택 화면에는 "사업자 구매회원"도 함께 보입니다 — 판매하려면 "사업자 판매회원" 또는 "개인 셀러회원"을 눌러야 합니다',
      ],
    ...
    },
    {
      ...
      detailedInstructions: [
        ...
        '사업자등록번호 3칸 입력 후 [사업자번호 인증] 클릭 → 통과하면 상호명이 자동으로 채워집니다',
        '개인 셀러는 휴대폰/아이핀 본인인증으로 대체',
        '인증 통과해야 다음 정보입력 단계로 진행',
      ],
      warning: '폐업/휴업 사업자번호, 조회 불가 번호는 이 단계에서 막힙니다. 인증이 안 되면 화면 안내대로 사업자등록번호 직접 등록 또는 FAX 접수(02-6280-6833)로 우회할 수 있고, 관련 문의는 NICE평가정보(02-3771-1011)입니다.',
      screen: {
        variant: 'form',
    ...
    },
    {
      ...
      detailedInstructions: [
        ...
        '사업자/단체 선택: 법인/단체 사업자 · 개인사업자 · 간이과세자 · 사회공헌단체 (4종)',
        '상호명·사업자등록번호는 앞 단계 인증값이 자동으로 채워집니다(회색 칸 = 수정 불가)',
        '아이디는 [중복확인]까지 눌러야 통과합니다',
        '해외구매대행은 업종을 "상품 중개업"으로 선택하는 게 관행',
      ],
      tip: '휴대폰 번호와 이메일 주소는 둘 다 입력하되 최소 1개는 인증까지 마쳐야 다음으로 넘어갑니다. 상호·업종은 사업자등록증과 100% 일치시켜야 서류심사 반려를 피해요.',
      screen: {
        variant: 'form',
        screenTitle: '계정 · 기본정보',
        fields: [
    ...
    },
    {
      ...
      detailedInstructions: [
        ...
        '가입완료 화면에 회원 상태가 "승인대기"로 표시됩니다',
        '전체 절차 4단계: 01 회원가입 신청 → 02 증빙서류 업로드 → 03 증빙서류심사 → 04 최종 가입완료',
        '이후 셀러오피스 로그인은 가능하나 판매개시는 서류 승인 후',
        '화면의 [증빙서류 업로드 하기] 버튼으로 바로 이동할 수 있습니다',
        '막히면 셀러 고객센터 02-2095-0689 / sellerhelp@11st.co.kr',
      ],
      screen: {
        variant: 'status',
        status: 'approved',
    ...
    },
    {
      ...
      detailedInstructions: [
        ...
        '파일 형식 JPG/GIF/PNG, 합계 10MB 이하 (실제 업로드 화면 기준)',
...
const lotteon: OnboardingGuide = {
  ...
  steps: [
    ...
    },
    {
      stepNumber: 4,
      hotspots: [
        { n: 1, x: 23, y: 30, label: '아이디는 [중복확인]까지 눌러야 통과합니다. 스토어센터 로그인에 쓸 계정이에요.' },
        { n: 2, x: 21, y: 55, label: '통신판매업 신고 전이면 [추후 입력]을 고르세요 — 여기서 막히지 않습니다.' },
        { n: 3, x: 19, y: 69, label: '업태·업종은 사업자등록증에 적힌 그대로 입력하세요.' },
        { n: 4, x: 76, y: 30, label: '정산계좌는 대표자 명의로 입력하고 [유효성 체크]를 누르세요.' },
        { n: 5, x: 70, y: 72, label: '주민등록번호·실거주주소는 자금세탁방지법상 필수라 건너뛸 수 없습니다.' },
      ],
      title: '추가정보 입력 (통신판매업·정산계좌·실소유자)',
      description: '통신판매업 신고번호·정산계좌·실소유자 정보를 입력합니다.',
      detailedInstructions: [
        '계정정보: 아이디(중복확인 필수)·비밀번호 설정 — 스토어센터 로그인에 씁니다',
        '통신판매업 신고번호는 [지금 입력] / [추후 입력] 중 고를 수 있습니다 (아직 신고 전이면 [추후 입력])',
        '업태·업종(대/중/소분류)·과면세구분·거래목적·거래자금출처 입력',
        '정산계좌는 대표자 명의로 입력 후 [유효성 체크], 대표자 주민등록번호·실거주주소까지 채우고 제출',
      ],
      warning: '정산계좌는 반드시 대표자 명의여야 하고 [유효성 체크]를 통과해야 합니다. 대표자 주민등록번호·실거주주소는 자금세탁방지법에 따른 필수 항목이라 건너뛸 수 없습니다.',
      tip: '통신판매업 신고가 아직이면 [추후 입력]을 고르고 진행하세요. 신고번호가 없다고 입점 신청이 막히지는 않습니다.',
      screen: {
        variant: 'form',
        screenTitle: '추가정보 입력',
        fields: [
    ...
    },
    {
      ...
      warning: '서류는 선명한 JPG로. 스토어센터 상단에 탭 4개(필수구비서류등록 · 선택약관동의 · 기본정보 확인/수정 · 추가정보 확인/수정)가 있고, 전부 "(미등록)"에서 "(등록)"으로 바뀌어야 심사가 시작됩니다. 하나라도 남으면 진행되지 않아요.',
      screen: {
        variant: 'upload',
        screenTitle: '서류 등록',
        docs: [
