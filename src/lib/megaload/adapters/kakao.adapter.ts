/**
 * 카카오쇼핑 스텁 어댑터 — 공식 셀러 API 미공개 상태
 *
 * 카카오톡 쇼핑하기 / 카카오 선물하기는 카카오 파트너센터에서 직접 입점 심사.
 * 일반 셀러용 공식 Open API 현재 미제공 (일부 대형 셀러만 내부 API 사용).
 *
 * 공식 Open API가 공개되면 이 파일을 실제 구현으로 교체.
 */
import { BaseAdapter } from './base.adapter';
import type { Channel } from '../types';

const STUB_ERROR = '카카오쇼핑 셀러 API는 현재 준비 중입니다. 공식 공개 후 자동 활성화됩니다.';

export class KakaoAdapter extends BaseAdapter {
