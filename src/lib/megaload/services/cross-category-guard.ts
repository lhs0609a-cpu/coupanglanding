...
const FORBIDDEN_TOKENS: Record<CategoryGroup, Set<string>> = {
  ...
  food_fresh: new Set([
    // 영양제/건강식품 어휘
    '영양제', '보충제', '건강기능식품', '시니어', '캡슐', '정제', '알약',
    // 가전/공산품 어휘
    '컴팩트', '슈퍼', '울트라', '맥스', '프로페셔널', '편리한', '고성능',
    '내구성', '견고한', '럭셔리', '실용적', '인테리어',
    '모던한', '클래식한', '심플한', '베이직', '트렌디', '세련된',
    '에코모드', '필터', '충전', '배터리', '와트',
    // 뷰티 어휘
    '저자극', '비건', '약산성', '데일리', '진정', '광채', '집중', '고보습',
    // 자동차
    '발수', '광택', '세차',
    // 펫
    '기호성', '소형견', '대형견',
  ...
  food_processed: new Set([
    '영양제', '보충제', '건강기능식품', '시니어', '캡슐', '정제', '알약',
    '컴팩트', '슈퍼', '울트라', '맥스', '프로페셔널', '고성능',
    '내구성', '견고한', '럭셔리', '실용적', '인테리어',
    '모던한', '클래식한', '심플한', '베이직', '트렌디',
    '저자극', '비건', '약산성', '진정', '광채', '집중', '고보습',
    '발수', '광택', '세차', '필터', '충전', '배터리',
    '기호성', '소형견', '대형견',
  ]),
  // 건강식품 (비타민/홍삼/오메가3 등 영양제)
  food_supplement: new Set([
    // 비식품 어휘만 차단 — 영양제/보충제 같은 자연스러운 단어는 OK
    '컴팩트', '슈퍼', '울트라', '맥스', '프로페셔널', '고성능',
    '내구성', '견고한', '럭셔리', '인테리어',
    '모던한', '클래식한', '심플한', '베이직', '트렌디',
    '저자극', '비건', '약산성', '진정', '광채',
