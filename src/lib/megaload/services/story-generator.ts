...
const CLOSING_TEMPLATES: Record<string, string[]> = {
  ...
  '식품': [
    ...
    '매일 꾸준히, {product}으로 {효과1} 관리를 시작하세요. 온 가족이 안심하고 섭취할 수 있습니다.',
  ],
  '생활용품': [
    '깨끗한 생활의 시작, {product}. 강력한 {효과1}으로 우리 가정을 깨끗하고 위생적으로 관리하세요.',
    '{product} 하나로 {효과1}부터 {효과2}까지! {추천대상}에서도 안전하게 사용할 수 있습니다.',
  ],
  '가전/디지털': [
  ...
  '출산/유아동': [
    '우리 아이를 위한 안전한 선택, {product}. 꼼꼼한 품질관리로 안심하고 사용하세요. {추천대상}에게 딱 맞는 제품입니다.',
