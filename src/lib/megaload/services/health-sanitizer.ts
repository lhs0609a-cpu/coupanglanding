...
const HEALTH_INGREDIENTS_RE = /오메가3|루테인|비오틴|콜라겐|유산균|프로바이오틱스|밀크씨슬|홍삼|마그네슘|칼슘|글루코사민|히알루론산|코엔자임|크릴오일|프로폴리스|쏘팔메토|엽산|가르시니아|스피루리나|클로렐라|흑마늘|비타민[A-EK]|철분|아연|셀레늄|보스웰리아|MSM|진세노사이드|프로틴|WPC|CLA|카테킨|비타민B군|크롬|구리|망간|요오드|칼륨|인(?!삼)|나이아신|판토텐산|콘드로이친|L-카르니틴|키토산|타우린|BCAA|크레아틴|L-글루타민|카제인/g;
...
const CATEGORY_INGREDIENT_MAP: Record<string, string[]> = {
  ...
  '비타민e': ['비타민E'],
  '비타민k': ['비타민K'],
  '멀티비타민': ['비타민C', '비타민D', '비타민B', '비타민B군', '비타민A', '비타민E', '비타민K', '비오틴', '엽산', '판토텐산', '나이아신', '철분', '아연', '셀레늄', '마그네슘', '칼슘', '크롬', '구리', '망간', '요오드', '칼륨'],
  '종합비타민': ['비타민C', '비타민D', '비타민B', '비타민B군', '비타민A', '비타민E', '비타민K', '비오틴', '엽산', '판토텐산', '나이아신', '철분', '아연', '셀레늄', '마그네슘', '칼슘', '크롬', '구리', '망간', '요오드', '칼륨'],
  '미네랄': ['마그네슘', '칼슘', '아연', '셀레늄', '철분', '구리', '망간', '크롬', '요오드', '칼륨'],
  '칼슘': ['칼슘', '마그네슘'],
  '마그네슘': ['마그네슘', '칼슘'],
  '철분': ['철분'],
  '아연': ['아연'],
