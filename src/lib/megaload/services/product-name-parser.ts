...
const INGREDIENT_RE = /비타민|오메가|프로바이오|유산균|콜라겐|히알루론|루테인|글루코사민|보스웰리아|밀크씨슬|실리마린|홍삼|인삼|마그네슘|칼슘|아연|철분|셀레늄|코엔자임|크릴|EPA|DHA|프로폴리스|엽산|비오틴|판토텐|나이아신|레티놀|세라마이드|나이아신아마이드|살리실|글리콜|스쿠알란|펩타이드|알로에|녹차|티트리|병풀|센텔라|시카|쌀|콩|석류|아르간|호호바|쉐어버터|카카오|코코넛/i;
