...
export const SELLERHUB_NAV_ITEMS = [
  { href: '/megaload/dashboard', label: '대시보드', icon: 'LayoutDashboard' },
  { href: '/megaload/orders', label: '주문관리', icon: 'ShoppingCart', badgeKey: 'pendingOrders' as const },
  { href: '/megaload/products', label: '상품관리', icon: 'Package' },
  { href: '/megaload/inventory', label: '재고관리', icon: 'Warehouse' },
  { href: '/megaload/cs', label: '문의관리', icon: 'MessageSquare', badgeKey: 'pendingInquiries' as const },
  { href: '/megaload/settlement', label: '정산', icon: 'Receipt' },
  { href: '/megaload/analytics', label: '통계', icon: 'BarChart3' },
  { href: '/megaload/automation', label: '자동화', icon: 'Zap' },
  { href: '/megaload/sourcing', label: '해외소싱', icon: 'Globe' },
  { href: '/megaload/channels', label: '채널관리', icon: 'Link' },
  { href: '/megaload/settings', label: '설정', icon: 'Settings' },
] as const;
