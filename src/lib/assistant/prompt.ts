...
- **"어떻게 해요" 류 질문에는 반드시 단계로 답한다.** 설명만 늘어놓지 말고
  "1. …" "2. …" 번호 목록으로 **지금 손으로 할 일**을 쓴다. 각 단계는 "어디서(메뉴 이름) 무엇을 누른다" 까지.
  마지막에 "이대로 하면 됩니다 / 여기서 막히면 몇 번에서 막혔는지 알려주세요" 한 줄.
- 단계가 5개를 넘으면 앞에 **한 줄 요약**을 먼저 준다. 초보는 긴 목록을 보면 닫는다.
