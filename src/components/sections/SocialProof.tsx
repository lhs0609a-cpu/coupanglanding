      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-amber-700">솔직히 말씀드릴게요</span>
          </motion.div>

          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
            이런 <span className="text-red-500">걱정</span> 하고 계시죠?
          </h2>

          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            저희도 알아요. 새로운 툴 도입이 쉬운 결정이 아니라는 것.
            <br />
            <strong className="text-gray-900">그래서 미리 답변 준비했습니다.</strong>
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {objections.map((item, index) => (
            <motion.div
              ...
              className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm hover:shadow-lg transition-shadow"
            >
              {/* Worry */}
              ...
              <div className="pl-11">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 rounded-full border border-green-200">
                  ...
                  <span className="text-sm font-bold text-green-700">{item.proof}</span>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 border border-purple-200 mb-4">
              ...
              <span className="text-sm font-medium text-purple-700">실제 AI 상품명 예시</span>
            </div>
            <h3 className="text-2xl font-bold text-gray-900">
              "AI가 만든 거 티 난다"고요? <span className="text-purple-600">직접 보세요.</span>
            </h3>
          </div>
          ...
          {/* Example Card */}
          <div className="max-w-3xl mx-auto bg-white rounded-2xl sm:rounded-3xl border border-gray-200 overflow-hidden shadow-lg">
            {/* Original */}
            <div className="p-4 sm:p-6 bg-red-50 border-b border-red-100">
              <p className="text-xs sm:text-sm font-medium text-red-600 mb-2">원본 상품명 (평범함)</p>
              <p className="text-sm sm:text-lg text-gray-800 bg-white p-2 sm:p-3 rounded-lg border border-red-200 break-words">
            ...
            <div className="p-4 sm:p-6 bg-green-50">
              <p className="text-xs sm:text-sm font-medium text-green-600 mb-3 sm:mb-4">AI 생성 상품명 (검색 최적화)</p>
              <div className="space-y-2 sm:space-y-3">
                {aiExamples[activeExample].generated.map((name, i) => (
                  ...
                  >
                    <span className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-500 text-white text-xs sm:text-sm font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                      {i + 1}
                    </span>
                    <p className="text-xs sm:text-sm text-gray-800 bg-white p-2 sm:p-3 rounded-lg border border-green-200 flex-1 break-words leading-relaxed">
                      {name}
                    </p>
                  </motion.div>
                ))}
              ...
              {/* Result */}
              <div className="mt-4 sm:mt-6 flex items-center justify-center gap-2 p-3 sm:p-4 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl border border-green-300">
                <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0" />
                <span className="font-bold text-green-700 text-sm sm:text-base text-center">{aiExamples[activeExample].result}</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-12 bg-gradient-to-r from-green-50 to-emerald-50 rounded-3xl p-8 border-2 border-green-200"
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <p className="text-gray-700 mb-4">
                30일간 사용해보시고, <strong className="text-green-700">기대한 효과가 없으면 전액 환불</strong>해드립니다.
              </p>
