...
import {
  X, ChevronUp, ChevronDown, CheckCircle2, AlertTriangle, XCircle, Pencil, Code2,
} from 'lucide-react';
...
export default function BulkProductDetailPanel({
  ...
  const [activeTab, setActiveTab] = useState<'info' | 'payload'>('info');
  ...
  // Auto-fetch preview when payload tab selected
  useEffect(() => {
