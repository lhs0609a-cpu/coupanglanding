...
const KIND_GUIDE = {
  fruit: {
    ...
    forbid: '',
    shot: '"택배 상자를 열자 향이 훅 올라왔어요. 한 입 베어 무니 사각 소리가 나면서 과즙이 손등까지 흘렀습니다. 예전에 마트에서 사다 이틀 만에 물러버린 게 떠올라서 더 반가웠어요. 냉장고에 두고 하나씩 꺼내 먹었는데 마지막까지 아삭했습니다."',
  },
  food: {
    sensory: '포장을 열 때 올라오는 냄새, 씹거나 조리했을 때의 식감·풍미, 보관/양의 실감',
    forbid: '과즙·베어 물면 같은 생과일 표현(먹더라도 과일이 아니면 쓰지 말 것)',
    shot: '"봉지를 뜯자 고소한 냄새가 확 퍼졌어요. 한 줌 씹어보니 생각보다 알이 실하고 씹는 맛이 좋더라고요. 양이 많아 부담스러울까 했는데, 소분해 두니 아침마다 한 컵씩 꺼내 쓰기 딱 좋았습니다."',
  },
  beauty: {
  ...
  generic: {
    ...
    shot: '"택배를 열어 처음 만져봤을 때 마감이 생각보다 꼼꼼했어요. 며칠 써보니 손에 익어서 이제는 없으면 아쉬울 정도입니다. 처음엔 반신반의했는데 값어치는 하더라고요."',
  },
};
